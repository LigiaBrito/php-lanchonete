...
class Lanche
{
    ...
    {
        $sqlstring = "Insert into lanche(id, nome, descricao, preco) values
    ...
    {
        $sqlstring = "Select * from lanche where id = $id";
        $dados = $conexao->query($sqlstring);
        return $dados;
    }

    public function editarLanche($conexao, $obj)
    {
        $sqlstring = "Update lanche set nome = '$obj->nome', descricao = '$obj->descricao',
                      preco = '$obj->preco' where id = $obj->id";
        if ($conexao->query($sqlstring))
            return true;
    }

    public function excluirLanche($conexao, $id)
    {
        $sqlstring = "delete from lanche where id = $id";
        if ($conexao->query($sqlstring))
            return true;
    }
    ...
    {
        $sqlstring = "select preco from lanche where nome = '$nome'";
